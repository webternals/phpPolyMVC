<?php
    ...
    use \Core\Constants\HttpStatusMessage as HttpStatusMessage;
    ...
    class Errors
    {
        ...
        public static function http_response_code($code = NULL)
        {
            ...
            $text = Errors::get_response_message($code);
        ...
        public static function get_response_message($code)
        {
            switch ($code) {
                ...
                case 101: $text = HttpStatusMessage::SWITCHING_PROTOCOLS; break;
                case 200: $text = HttpStatusMessage::OK; break;
